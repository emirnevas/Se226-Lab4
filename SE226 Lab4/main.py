...
while(True):
    small_num = int(input("Please enter a number between 1 and 999: "))
    if(small_num >= 1 and small_num <= 999):
        break
    else:
        print("Invalid input.")

while(True):
    large_num = int(input("Please enter a number between 1 and 999: "))
    if(large_num > small_num and large_num <= 999):
        break
    else:
        print("Invalid input.")

sliced_words = words[small_num : large_num : 1]
# Question 2
...
if 3 <= user_number <= 7:
    ...
    print("Your password is:", reversed_password)
else:
    print("Error: The number must be between 3 and 7 (inclusive).")
...
for i in range(8):
    ...
    print("Your password is:", reversed_password)
    if user_number < 5:
        shorter.add(reversed_password)
    else:
        longer.add(reversed_password)
